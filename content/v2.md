...
<span style="color: red; font-size: 14px ">Basic</span> theo sau là một khoảng trắng và một mã hoá Base64 <span style="color: red; font-size: 14px ">username:password</span>. Ví dụ, <span style="color: red; font-size: 14px ">demo:p@55w0rd</span> client sẽ gửi
